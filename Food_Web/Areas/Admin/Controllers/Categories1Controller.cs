...
namespace Food_Web.Areas.Admin.Controllers
{
    public class Categories1Controller : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "Categoryid,Categoryname,image")] Category category)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "Categoryid,Categoryname,image")] Category category)
        {
            if (ModelState.IsValid)
            {
